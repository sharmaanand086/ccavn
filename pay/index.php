			...
			<div class="section-lft">
				<form name="form1" method="POST" id = "form1" action = "online.php" onsubmit="return validateForm()">
					...
					<div class="stp-4">
						...
						<div class="price" >Rs.<label id="ptotal">0</label></div>
						<div class="clearfix"></div>
						<hr>
						<div class="product_name">GST :</div>
						<div class="price" >Rs.<label id="gsttotal">0</label></div>
						<div class="clearfix"></div>
						<hr>
						<div class="product_name ">Total Price:</div>
						<div class="price">Rs.<label id="total"><span class="rupe" id="pstotal">0</span></label></div>
						<div class="clearfix"></div>
					</div>
