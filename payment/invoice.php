...
if ($app->cfgCon("connectionName")) 
{
	...
	try 
	{
		...
		$mail->Subject = 'Coach To Fortune  By Arfeen Khan';
		$mail->Body= '<html>
  <head>
  </head>
  <body>
                                ...
                                <table width="100%" id="purchasesTable" style="margin-top:2%">
                                  <tr id="purchaseRowsHeader">
									...
									<tr style="font-size: 14px;">
										...
										<td style="text-align:left ; padding: 5px;">Coach To Fortune  By Arfeen Khan</td>
										<td style="text-align:center; padding: 5px;">USD.'.$_SESSION['total'].'</td>
										<td style="text-align:center; padding: 5px;">USD.'.$_SESSION['total'].'</td>
									</tr>
                                      <tr style="font-size: 14px;">
                                  ...
                                  <tr>
                                    <td><table width="100%" cellpadding="0" cellspacing="0">
                                      ...
                                      <tr style="font-size: 14px;">
                                        ...
                                        <td style="text-align:right; padding:5px;">USD.'.$_SESSION['total'].'</td>
                                      </tr>
                                      <tr style="font-size: 14px;">
                                  ...
                                  <tr>
                                    <td><table width="100%" cellpadding="0" cellspacing="0">
                                      ...
                                      <tr style="font-size: 14px;">
                                        ...
                                        <td style="text-align:right; padding: 5px;">USD.00.00</td>
                                      </tr>
                                      <tr style="font-size: 14px;">
                                        <td style="padding:5px;"><b>OutstandingBalance</b></td>
                                        <td style="text-align:center; padding: 5px;">&nbsp;</td>
                                        <td style="text-align:right; padding: 5px;">USD.0.00</td>
                                      </tr>
                                      <tr style="font-size: 14px;">
...
?> 
	<script>window.location = "http://arfeenkhan.com/payment/thankyou/";</script>
<?php } ?>