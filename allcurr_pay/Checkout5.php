	...
	<form method="post" name="customerData" action="ccavRequestHandler5.php">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="40%" height="100" border='1' align="center">
				...
				<tr>
					<td>si_start_date	:</td><td><input type="text" name="si_start_date" value="10-05-2020"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td>si_bill_cycle	:</td><td><input type="text" name=" si_bill_cycle" value="1"/></td>
				</tr>
				...
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="http://coachtofortune.com/webinar/pay/ccavResponseHandler6.php"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="http://coachtofortune.com/webinar/pay/ccavResponseHandler6.php"/></td>
			 	</tr>
			 	<tr>
