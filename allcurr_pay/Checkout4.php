...
<body>
	<form method="post" name="customerData" action="ccavRequestHandler4.php">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="40%" height="100" border='1' align="center">
				...
				<tr>
					<td>si_amount	:</td><td><input type="text" name="si_amount" value="15000"/></td>
				</tr>
				<tr>
					<td>amount	:</td><td><input type="text" name="amount" value="15000"/></td>
				</tr>
				<tr>
					<td>si_start_date	:</td><td><input type="text" name="si_start_date" value="3-10-2019"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="http://www.arfeenkhan.com/incredibleyou/pay/ccavResponseHandler4.php"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="http://www.arfeenkhan.com/incredibleyou/pay/ccavResponseHandler4.php"/></td>
			 	</tr>
			 	<tr>
