...
<body>
	<form method="post" name="customerData" action="ccavRequestHandler6.php" style="display:none;">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="40%" height="100" border='1' align="center">
				...
				<!--</tr>-->
				<tr>
					<td>amount	:</td><td><input type="text" name="amount" value="11800"/></td>
				</tr>
				<!--<tr>-->
				...
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="http://arfeenkhan.com/smb/go/ccavResponseHandler6.php"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="http://arfeenkhan.com/smb/go/ccavResponseHandler6.php"/></td>
			 	</tr>
			 	<tr>
