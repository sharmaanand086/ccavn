...
if ($app->cfgCon("connectionName")) 
{
	...
	echo $price = $_SESSION['total'];
	echo $curr = $_SESSION['curr'];
	$gst;
	$price1;
	$totap ;
	$abc = '';
	    ...
	    $gst=7199;
	     ...
	     $abc .= '<tr style="font-size: 14px;">
										...
										<td style="text-align:center; padding: 5px;">'.$curr.' .'.$gst.'</td>
									</tr>';
 	    }
 	    if($price == 560){
	     $price1 = 560;
	...
	$result = $app->addOrderItem($invoiceId, 89, 4, doubleval( $price ), 1, "The Incredible You System", "The Incredible You System");
                                ...
                                <table width="100%" id="purchasesTable" style="margin-top:2%">
                                  <tr id="purchaseRowsHeader">
									...
									<tr style="font-size: 14px;">
										...
										<td style="text-align:left ; padding: 5px;">The Incredible You System By Arfeen Khan</td>
										<td style="text-align:center; padding: 5px;">'.$curr.' .'.$price1.'</td>
										<td style="text-align:center; padding: 5px;">'.$curr.' .'.$price1.'</td>
									</tr>
									'.$abc.'
                                      ...
                                      <tr style="font-size: 14px;">
                                        ...
                                        <td style="text-align:center; padding: 5px;">&nbsp;</td>
                                        <td style="text-align:center ; padding: 5px;">&nbsp;</td>
                                        <td style="text-align:center ; padding: 5px;">'.$curr.'  .'.$totap.'</td>
                                      </tr>
                                    </table></td>
                                  </tr>
                                </table>
                                  ...
                                  <tr>
                                    <td><table width="100%" cellpadding="0" cellspacing="0">
                                      ...
                                      <tr style="font-size: 14px;">
                                        ...
                                        <td style="text-align:right; padding:5px;">'.$curr.' .'.$totap.'</td>
                                      </tr>
                                      <tr style="font-size: 14px;">
                                        <td style="padding: 5px;"><b>Total</b></td>
                                        <td style="text-align:center;padding: 5px;">&nbsp;</td>
