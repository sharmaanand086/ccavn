	...
	<form method="post" name="customerData" action="ccavRequestHandler.php" >
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="40%" height="100" border='1' align="center">
				...
				<tr>
					<td>Order Id	:</td><td><input type="text" name="order_id" value="<?php echo $contact."_".rand(10,100); ?>"/></td>
				</tr>
				<!--<tr>-->
				...
				<tr>
					<td>Currency	:</td><td><input type="text" name="currency" value="<?php echo $_POST['currency']; ?>"/></td>
				</tr>
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="https://www.arfeenkhan.com/incredibleyou/pay/ccavResponseHandler.php"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="https://www.arfeenkhan.com/incredibleyou/pay/ccavResponseHandler.php"/></td>
			 	</tr>
			 	<tr>
